						...
						<div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8">
							{stats.map((stat) => (
								<div key={stat.label} className="text-center group">
									<div
										className={`inline-flex p-3 md:p-4 rounded-xl md:rounded-2xl bg-background mb-3 md:mb-4 ${stat.color} group-hover:scale-110 transition-transform duration-300`}
									>
										<stat.icon className="size-6 md:size-8" />
									</div>
									<div className="text-2xl sm:text-3xl lg:text-5xl font-bold mb-1 md:mb-2">
