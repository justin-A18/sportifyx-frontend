				...
				<div className="relative max-w-4xl mx-auto text-center">
					...
					<div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4">
						<Link href="/auth/register">
							<Button
								size="lg"
								className="h-12 md:h-14 px-6 md:px-10 text-base md:text-lg font-semibold shadow-xl shadow-primary/25 hover:shadow-primary/40 w-full sm:w-auto"
							>
						...
						<Link href="/auth/login">
							<Button
								variant="outline"
								size="lg"
								className="h-12 md:h-14 px-6 md:px-10 text-base md:text-lg font-semibold border-2 bg-background/50 w-full sm:w-auto"
							>
								Iniciar sesión
							</Button>
						</Link>
